...
_G.packer_plugins = {
  ...
  everforest = {
    loaded = true,
    path = "/home/luca/.local/share/nvim/site/pack/packer/start/everforest",
    url = "https://github.com/neanias/everforest-nvim"
  },
  ["gruv-material"] = {
    loaded = true,
    path = "/home/luca/.local/share/nvim/site/pack/packer/start/gruv-material",
  ...
  kanagawa = {
    loaded = true,
    path = "/home/luca/.local/share/nvim/site/pack/packer/start/kanagawa",
  ...
  material = {
    loaded = true,
    path = "/home/luca/.local/share/nvim/site/pack/packer/start/material",
    url = "https://github.com/marko-cerovac/material.nvim"
  },
  neogruv = {
    loaded = true,
    path = "/home/luca/.local/share/nvim/site/pack/packer/start/neogruv",
  ...
  omonokai = {
    loaded = true,
    path = "/home/luca/.local/share/nvim/site/pack/packer/start/omonokai",
    url = "https://github.com/justinsgithub/oh-my-monokai.nvim"
  },
  ["one-monokai"] = {
    loaded = true,
    path = "/home/luca/.local/share/nvim/site/pack/packer/start/one-monokai",
